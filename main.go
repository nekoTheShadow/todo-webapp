...
func main() {
	...
	e.Renderer = &Template{
		templates: template.Must(template.New("").Funcs(template.FuncMap{"FormatDateTime": formatDateTime}).ParseFS(templates, "templates/*")),
	}
	...
	e.GET("/", func(c echo.Context) error {
		...
		if err != nil {
			e.Logger.Error(err)
			return c.Render(http.StatusBadRequest, "index", Data{Errors: []error{errors.New("Cannot get todos")}})
		}
